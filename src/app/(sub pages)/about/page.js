...
export default function Home() {
  return (
    ...
    <div className="absolute flex flex-col items-center text-center top-[75%] left-1/2 -translate-y-1/2 -translate-x-1/2" >

    
      <h1 className=" text-3xl text-accent">"सर्वे भवन्तु सुखिनः, सर्वे सन्तु निरामयाः।"</h1>
      <p className="font-light text-foreground mt-10 text-ls">~ May all beings be happy, may all beings be free from illness.</p>
