...
{/*       
      <Image src={happy} alt ="background-image"  className="-z-50 fixed top-4 left-10 hidden xs:h-20 xs:w-20 sm:h-30 sm:w-30 md:h-40 md:w-40 object-cover object-center opacity-70 justify-center items-center "/> */}
      ...
      <article className="relative w-full flex flex-col items-center justify-center py-8 sm:py-0 space-y-8">
        ...
        <CiVirus className="text-white text-8xl hover:text-accent transition ease-in-out duration-250 motion-safe:animate-spin-slow" />
          ...
          <h1 className=" whitespace-nowrap text-accent font-semibold tex-center text-4xl capitalize">Contact Happy Yadav</h1>
