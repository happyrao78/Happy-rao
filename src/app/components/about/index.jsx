    ...
    <section className='py-20 w-full'>
      <div className='grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full'>
        {/* <ItemLayout className={'col-span-full lg:col-span-8 row-span-2 flex-col items-start'}>
          ...
          <p className='font-light text-xs sm:text-sm md:text-xl'>
          Young Founder & CEO @Sankalpiq • National Finalists @HackRx 5.0 : Bajaj Finserv • 2x Invitee @Microsoft • 15x Hackathons • Technical Director : @CodingNinjasCUIET • Ex-Intern @Hunar.ai | @BiharInnovation
          </p>
        </ItemLayout> */}
        ...
        <ItemLayout className={"col-span-full md:col-span-6  !p-0"}>
          <img className="w-full h-auto" src="https://github-readme-stats.vercel.app/api/pin/?username=happyrao78&repo=loan-project&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false&description_lines_count=10" alt="happy yadav" loading='lazy' />
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full md:col-span-6  !p-0"}>
          <img className="w-full h-auto" src="https://github-readme-stats.vercel.app/api/pin/?username=happyrao78&repo=scrap-articles&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=true" alt="happy yadav" loading='lazy' />
        </ItemLayout>
      </div>
    </section>
  );
