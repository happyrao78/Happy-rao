  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (responseData.success) {
        toast.success('Your message has been sent successfully to Happy Yadav, he will get back to you soon!', { id: toastId });
        reset(); // Clear form fields after successful submission
      } else {
        toast.error('There was an error submitting the form. Please try again later.', { id: toastId });
      }
    } catch (error) {
